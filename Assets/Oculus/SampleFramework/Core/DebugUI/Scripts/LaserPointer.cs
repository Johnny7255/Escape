...
public class LaserPointer : OVRCursor
{
    ...
    public GameObject cursorVisual;//跟随射线的球
    ...
    public override void SetCursorStartDest(Vector3 start, Vector3 dest, Vector3 normal)//设置光标边界
    {
        _startPoint = start;
        _endPoint = dest;
        _hitTarget = true;
    ...
    public override void SetCursorRay(Transform t)//定位光线
    {
