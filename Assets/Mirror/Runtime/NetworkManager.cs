...
#pragma warning restore 618
        ...
        void OnServerAddPlayerInternal(NetworkConnection conn, AddPlayerMessage msg)
        {
            ...
            if (autoCreatePlayer && playerPrefabs.Count<1)
            {
        ...
        {
            playerPrefab = playerPrefabs[new System.Random().Next(playerPrefabs.Count)];
        ...
        public static string GetLocalIp()
        {
            if (_localIpv4 == null)
            {
                ...
                foreach (IPAddress item in localhost.AddressList)
                    ...
                    {
                        return _localIpv4 = item.MapToIPv4().ToString();
                    }
                return "localhost";
            }
