...
[ExecuteInEditMode]
public class Book : UILocater {
    public Canvas canvas;
    [SerializeField]
    RectTransform BookPanel;
    public Sprite background;
    public Sprite[] bookPages;
    public String[] bookContains;
    ...
    public TMP_Text rightNextText;
    public TMP_Text leftNextText;
    ...
    public Vector3 transformPoint(Vector3 mouseScreenPos)
    {
            ...
            Vector2 localPos;
            #if UNITY_EDITOR
            localPos = BookPanel.InverseTransformPoint(ray.GetPoint(distance));
            #else 
            localPos = BookPanel.InverseTransformPoint(GetLaserPointerPosition());
            #endif
            return localPos;
    ...
    public void DragRightPageToPoint(Vector3 point)
    {
        ...
        // 加上文字
        leftText.text = (currentPage < bookPages.Length) ? bookContains[currentPage] : " ";
        leftText.color = new Vector4(0, 0, 0, 0.4f);
        Left.transform.SetAsFirstSibling();
        ...
        // 加上文字
        rightText.text = (currentPage < bookPages.Length - 1) ? bookContains[currentPage + 1] : " ";

        RightNext.sprite = (currentPage < bookPages.Length - 2) ? bookPages[currentPage + 2] : background;
        rightNextText.text = (currentPage < bookPages.Length - 2) ? bookContains[currentPage + 2] : " ";
        rightNextText.color = new Vector4(0, 0, 0, 0.4f);
    ...
    public void DragLeftPageToPoint(Vector3 point)
    {
        ...
        rightText.text = bookContains[currentPage - 1];
        ...
        leftText.text = (currentPage >= 2) ? bookContains[currentPage - 2] : " ";


        LeftNext.sprite = (currentPage >= 3) ? bookPages[currentPage - 3] : background;
        leftNextText.text = (currentPage >= 3) ? bookContains[currentPage - 3] : " ";
    ...
    void UpdateSprites()
    {
        ...
        leftNextText.text = (currentPage > 0 && currentPage <= bookPages.Length) ? bookContains[currentPage-1] : " ";
        leftNextText.color = new Vector4(0, 0, 0, 0.4f);

        RightNext.sprite = (currentPage >= 0 && currentPage < bookPages.Length) ? bookPages[currentPage] : background;
        rightNextText.text = (currentPage >= 0 && currentPage < bookPages.Length) ? bookContains[currentPage] : " ";
        rightNextText.color = new Vector4(0, 0, 0, 0.4f);
